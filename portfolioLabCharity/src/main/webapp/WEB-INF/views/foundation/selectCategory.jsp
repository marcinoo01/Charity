...
<header class="header--form-page">
    <nav class="container container--70">
        <jsp:include page="../components/config-user.jsp"/>
    ...
    <div class="form--steps-container">
        ...
        <form:form modelAttribute="donation" action="/user/donation" method="post" id="form" htmlEscape="true">
            ...
            <div data-step="3">
                ...
                <c:forEach items="${foundations}" var="institution">
                    <div class="form-group form-group--checkbox">
                        <label>
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <label>Telefon<form:input type="phone" name="phone" path="phoneNumber"/></label>
                        </div>
                    </div>
