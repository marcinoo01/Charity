...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="/foundation" class="btn btn--without-border">O co chodzi?</a></li>
        ...
        <form:form modelAttribute="donation" method="post">
            ...
            <div data-step="3">
                ...
                <c:forEach items="${foundations}" var="foundation">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <input type="radio" name="institution" value="${foundation.id}"/>
                            <span class="checkbox radio"></span>
                            <span class="description">
                            <div class="title">
                                Fundacja ${foundation.name}
                            </div>
                  <div class="subtitle">
                    Cel i misja: ${foundation.description}
                  </div>
                </span>
                        </label>
                    </div>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Data <form:input type="date" name="pickUpDate" path="pickUpDate"
                                                     placeholder="Wybierz date"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Godzina <form:input type="time" name="pickUpTime" path="pickUpTime"
                                                        placeholder="Wybierz date"/> </label>
                        </div>
                ...
                <div class="form-group form-group--buttons">
                    <button type="button" class="btn prev-step">Wstecz</button>
                    <button type="button" id="last-button" class="btn next-step">Dalej</button>
                </div>
            </div>
