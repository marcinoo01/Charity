...
<ul>
    ...
    <security:authorize access="hasRole('ROLE_ADMIN')">
        <li><a href="/admin/institutions" class="btn btn--without-border active" style="background: cadetblue">Organizacje</a>
        </li>
    </security:authorize>
    <security:authorize access="hasRole('ROLE_ADMIN')">
        <li><a href="/admin/users" class="btn btn--without-border active" style="background: cadetblue">Użytkownicy</a>
        </li>
    </security:authorize>
    <security:authorize access="hasRole('ROLE_USER')">
        <li><a href="/user/donation/list" class="btn btn--without-border active">Przekazane dary</a></li>
    </security:authorize>
    <li><a href="#stats" class="btn btn--without-border"><spring:message
            code="pages.navbar.button.project_description"/></a></li>
